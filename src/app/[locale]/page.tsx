    ...
    async function fetchData() {
      try {
        ...
        if (!categoriesRes.ok || !promptsRes.ok || !freeRes.ok || !newRes.ok) {
          throw new Error(t("errors.loadFailed", { ns: "common" }));
        }
        ...
        setError(t("errors.loadFailedRetry", { ns: "common" }));
      } finally {
        setLoading(false);
      }
    }
        ...
        <section className="py-16 bg-[#0f0f0f]">
          <div className="container mx-auto px-4">
                      ...
                      <div className="relative z-10 flex-1 flex flex-col p-6 pt-8">
                        ...
                        <div className="text-center mb-2">
                          ...
                          <span className="text-gray-400 text-sm me-1">
                            {" "}
                            {t("labels.creditsPerMonth", { ns: "common" })}
                          </span>
                        </div>
            ...
            <div className="mt-8 flex justify-center">
              ...
              >
                <LocaleLink href="/subscription">
                  {t("buttons.viewAllPlans", { ns: "common" })}
                  ...
                  <div className="group relative bg-[#1a1a20] tech-clip-both border border-white/5 hover:border-[#7f0df2]/50 p-6 h-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(127,13,242,0.2)]">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center gap-3 border-t border-white/5 pt-4">
                        <img
                          src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(testimonial.avatarSeed)}&backgroundColor=ffdfbf`}
