        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="col-span-1 md:col-span-8 relative rounded-3xl overflow-hidden min-h-[300px] group cursor-pointer">
            <img
              ...
              alt={t("featured.banner.alt", { ns: "home" })}
            ...
            <div className="absolute bottom-0 right-0 p-8 max-w-lg">
              <span className="bg-[#7f0df2] text-white text-xs font-bold px-2 py-1 rounded mb-3 inline-block">
                {t("featured.banner.badge", { ns: "home" })}
              </span>
              <h3 className="text-3xl font-bold text-white mb-2">
                {t("featured.banner.title", { ns: "home" })}
              </h3>
              <p className="text-gray-300 mb-4 line-clamp-2">
                {t("featured.banner.description", { ns: "home" })}
              </p>
              <LocaleLink
                href="/market"
                className="inline-block bg-white text-black font-bold px-6 py-2 rounded-lg hover:bg-[#faff00] transition-colors"
              >
                {t("buttons.exploreBundle", { ns: "common" })}
              </LocaleLink>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-4 flex flex-col gap-6">
            <CategoryCard
              icon={Landmark}
              title={t("featured.categories.architecture.title", { ns: "home" })}
              subtitle={t("featured.categories.architecture.subtitle", { ns: "home" })}
              glowColor="#7f0df2"
            ...
            <CategoryCard
              icon={Code}
              title={t("featured.categories.coding.title", { ns: "home" })}
              subtitle={t("featured.categories.coding.subtitle", { ns: "home" })}
              glowColor="#faff00"
